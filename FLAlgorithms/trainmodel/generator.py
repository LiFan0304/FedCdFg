...
class Generator(nn.Module):
    ...
    def init_loss_fn(self):
        ...
        self.crossentropy_loss1 = nn.NLLLoss()
    ...
    def forward(self, labels, flag, perturbation, latent_layer_idx=-1, verbose=True):
        """
        G(Z|y) or G(X|y):
